...
const RankCard = () => {
    return (
            <div className='box flex flex-col bg-stone-700/70 dark:bg-neutral-700 dark:text-white text-black w-[90%] h-60 relative px-2 pt-5 rounded hover:border-red-600 hover:border-2'>
            ...
            <footer className='flex justify-center items-center flex-1'>
                <Link className='bg-blue-600 py-2 px-3 rounded active:bg-red-500 hover:opacity-80' to='/'>View details</Link>
            </footer>
        </div>
    )
}
