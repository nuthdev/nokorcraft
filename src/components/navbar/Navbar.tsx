...
const Navbar = () => {
    ...
    return (
        <nav className="flex items-center w-full bg-neutral-900/60 h-12 text-white justify-between overflow-visible relative">
            ...
            <div className='flex mr-3.5 gap-5'>
                <ul className='flex gap-2 hidden lg:flex'>
                    <li>Home</li>
                    <li>Store</li>
                    <li>Contact</li>
                </ul>
                <div className='flex gap-2'>
                    ...
                    <div onClick={toggleMenu} className='lg:hidden transition-all mr-3'>
            ...
            <ul ref={mobileLinks} className='lg:hidden absolute top-full text-white w-full h-0 max-h-max text-center  overflow-hidden bg-neutral-900/80 *:cursor-pointer transition-all duration-200'>
                <li>Home</li>
                <li>Store</li>
                <li>Contact</li>
            </ul>
